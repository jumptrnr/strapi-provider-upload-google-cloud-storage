...
const setConfigField = (fieldValue, defaultValue) => {
  console.log('setConfigField', fieldValue, defaultValue);
...
const checkServiceAccount = (config = {}) => {
  console.log('checkServiceAccount', config);
...
const checkBucket = async (GCS, bucketName) => {
  console.log('checkBucket', bucketName);
...
const generateUploadFileName = (basePath, file) => {
  console.log('generateUploadFileName', file);
